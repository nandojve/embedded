...
retval_t pal_sio_init(uint8_t sio_unit)
{
    ...
    switch (sio_unit)
    {
        ...
        case SIO_2:
    #ifdef BAUD_RATE
            sio_uart_2_init(BAUD_RATE);
    #else
            sio_uart_2_init(9600);
    #endif
            break;
#endif
        default:
...
#endif
#ifdef UART2
        case SIO_2: number_of_bytes_transmitted = sio_uart_2_tx(data, length);
                    break;
#endif
...
#endif
#ifdef UART2
        case SIO_2: number_of_bytes_received = sio_uart_2_rx(data, max_length);
                    break;
#endif
