...
#ifdef MAC_USER_BUILD_FEATURE_CONFIG
#include "mac_user_build_feature_config.h"
#else

/**
 * USE DEFINED FEATURES
 *
 * 0 - Not Compile MAC STUB File
 * 1 - Compile MAC STUB File
 * 2 - User Defined MAC Callback
 *
 */
#define	USR_MCPS_DATA_CONF						(1)
#define	USR_MCPS_DATA_IND						(1)
#define	USR_MCPS_PURGE_CONF						(1)

#define	USR_MLME_ASSOCIATE_CONF					(1)
#define	USR_MLME_ASSOCIATE_IND					(1)
#define	USR_MLME_BEACON_NOTIFY_IND				(1)
#define	USR_MLME_COMM_STATUS_IND				(1)
#define	USR_MLME_DISASSOCIATE_CONF				(1)
#define	USR_MLME_DISASSOCIATE_IND				(1)
#define	USR_MLME_GET_CONF						(1)
#define	USR_MLME_ORPHAN_IND						(1)
#define	USR_MLME_POLL_CONF						(1)
#define	USR_MLME_RESET_CONF						(1)
#define	USR_MLME_RX_ENABLE_CONF					(1)
#define	USR_MLME_SCAN_CONF						(1)
#define	USR_MLME_SET_CONF						(1)
#define	USR_MLME_START_CONF						(1)
#define	USR_MLME_SYNC_LOSS_IND					(1)

#endif /* MAC_USER_BUILD_FEATURE_CONFIG */
