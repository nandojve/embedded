...
#if (!defined(USR_MLME_SYNC_LOSS_IND) || USR_MLME_SYNC_LOSS_IND > 2)
#error User must define USR_MLME_SYNC_LOSS_IND (0-Not compile, 1-Compile Stub, 2-User Defined Callback)
#elif (USR_MLME_SYNC_LOSS_IND == 1)
...
#endif /* (USR_MLME_SYNC_LOSS_IND == 1) */
