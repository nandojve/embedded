...
#if (!defined(USR_MLME_SCAN_CONF) || USR_MLME_SCAN_CONF > 2)
#error User must define USR_MLME_SCAN_CONF (0-Not compile, 1-Compile Stub, 2-User Defined Callback)
#elif (USR_MLME_SCAN_CONF == 1)
