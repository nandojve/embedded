...
struct st_l2c
{                                                          /* L2C              */
    uint32_t       REG0_CACHE_ID;                          /*  REG0_CACHE_ID   */
    uint32_t       EG0_CACHE_TYPE;                         /*  EG0_CACHE_TYPE  */
    uint8_t        dummy8[248];                            /*                  */
    uint32_t       REG1_CONTROL;                           /*  REG1_CONTROL    */
    uint32_t       REG1_AUX_CONTROL;                       /*  REG1_AUX_CONTROL */
    uint32_t       REG1_TAG_RAM_CONTROL;                   /*  REG1_TAG_RAM_CONTROL */
    uint32_t       REG1_DATA_RAM_CONTROL;                  /*  REG1_DATA_RAM_CONTROL */
    uint8_t        dummy9[240];                            /*                  */
    uint32_t       REG2_EV_COUNTER_CTRL;                   /*  REG2_EV_COUNTER_CTRL */
    uint32_t       REG2_EV_COUNTER1_CFG;                   /*  REG2_EV_COUNTER1_CFG */
    uint32_t       REG2_EV_COUNTER0_CFG;                   /*  REG2_EV_COUNTER0_CFG */
    uint32_t       REG2_EV_COUNTER1;                       /*  REG2_EV_COUNTER1 */
    uint32_t       REG2_EV_COUNTER0;                       /*  REG2_EV_COUNTER0 */
    uint32_t       REG2_INT_MASK;                          /*  REG2_INT_MASK   */
    uint32_t       REG2_INT_MASK_STATUS;                   /*  REG2_INT_MASK_STATUS */
    uint32_t       REG2_INT_RAW_STATUS;                    /*  REG2_INT_RAW_STATUS */
    uint32_t       REG2_INT_CLEAR;                         /*  REG2_INT_CLEAR  */
    uint8_t        dummy10[1292];                          /*                  */
    uint32_t       REG7_CACHE_SYNC;                        /*  REG7_CACHE_SYNC */
    uint8_t        dummy11[60];                            /*                  */
    uint32_t       REG7_INV_PA;                            /*  REG7_INV_PA     */
    uint8_t        dummy12[8];                             /*                  */
    uint32_t       REG7_INV_WAY;                           /*  REG7_INV_WAY    */
    uint8_t        dummy13[48];                            /*                  */
    uint32_t       REG7_CLEAN_PA;                          /*  REG7_CLEAN_PA   */
    uint8_t        dummy14[4];                             /*                  */
    uint32_t       REG7_CLEAN_INDEX;                       /*  REG7_CLEAN_INDEX */
    uint32_t       REG7_CLEAN_WAY;                         /*  REG7_CLEAN_WAY  */
    uint8_t        dummy15[48];                            /*                  */
    uint32_t       REG7_CLEAN_INV_PA;                      /*  REG7_CLEAN_INV_PA */
    uint8_t        dummy16[4];                             /*                  */
    uint32_t       REG7_CLEAN_INV_INDEX;                   /*  REG7_CLEAN_INV_INDEX */
    uint32_t       REG7_CLEAN_INV_WAY;                     /*  REG7_CLEAN_INV_WAY */
    uint8_t        dummy17[256];                           /*                  */
/* start of struct st_l2c_from_reg9_d_lockdown0 */
    uint32_t       REG9_D_LOCKDOWN0;                       /*  REG9_D_LOCKDOWN0 */
    uint32_t       REG9_I_LOCKDOWN0;                       /*  REG9_I_LOCKDOWN0 */
/* end of struct st_l2c_from_reg9_d_lockdown0 */
/* start of struct st_l2c_from_reg9_d_lockdown0 */
    uint32_t       REG9_D_LOCKDOWN1;                       /*  REG9_D_LOCKDOWN1 */
    uint32_t       REG9_I_LOCKDOWN1;                       /*  REG9_I_LOCKDOWN1 */
/* end of struct st_l2c_from_reg9_d_lockdown0 */
/* start of struct st_l2c_from_reg9_d_lockdown0 */
    uint32_t       REG9_D_LOCKDOWN2;                       /*  REG9_D_LOCKDOWN2 */
    uint32_t       REG9_I_LOCKDOWN2;                       /*  REG9_I_LOCKDOWN2 */
/* end of struct st_l2c_from_reg9_d_lockdown0 */
/* start of struct st_l2c_from_reg9_d_lockdown0 */
    uint32_t       REG9_D_LOCKDOWN3;                       /*  REG9_D_LOCKDOWN3 */
    uint32_t       REG9_I_LOCKDOWN3;                       /*  REG9_I_LOCKDOWN3 */
/* end of struct st_l2c_from_reg9_d_lockdown0 */
/* start of struct st_l2c_from_reg9_d_lockdown0 */
    uint32_t       REG9_D_LOCKDOWN4;                       /*  REG9_D_LOCKDOWN4 */
    uint32_t       REG9_I_LOCKDOWN4;                       /*  REG9_I_LOCKDOWN4 */
/* end of struct st_l2c_from_reg9_d_lockdown0 */
/* start of struct st_l2c_from_reg9_d_lockdown0 */
    uint32_t       REG9_D_LOCKDOWN5;                       /*  REG9_D_LOCKDOWN5 */
    uint32_t       REG9_I_LOCKDOWN5;                       /*  REG9_I_LOCKDOWN5 */
/* end of struct st_l2c_from_reg9_d_lockdown0 */
/* start of struct st_l2c_from_reg9_d_lockdown0 */
    uint32_t       REG9_D_LOCKDOWN6;                       /*  REG9_D_LOCKDOWN6 */
    uint32_t       REG9_I_LOCKDOWN6;                       /*  REG9_I_LOCKDOWN6 */
/* end of struct st_l2c_from_reg9_d_lockdown0 */
/* start of struct st_l2c_from_reg9_d_lockdown0 */
    uint32_t       REG9_D_LOCKDOWN7;                       /*  REG9_D_LOCKDOWN7 */
    uint32_t       REG9_I_LOCKDOWN7;                       /*  REG9_I_LOCKDOWN7 */
/* end of struct st_l2c_from_reg9_d_lockdown0 */
    uint8_t        dummy18[16];                            /*                  */
    uint32_t       REG9_LOCK_LINE_EN;                      /*  REG9_LOCK_LINE_EN */
    uint32_t       REG9_UNLOCK_WAY;                        /*  REG9_UNLOCK_WAY */
    uint8_t        dummy19[680];                           /*                  */
    uint32_t       REG12_ADDR_FILTERING_START;             /*  REG12_ADDR_FILTERING_START */
    uint32_t       REG12_ADDR_FILTERING_END;               /*  REG12_ADDR_FILTERING_END */
    uint8_t        dummy20[824];                           /*                  */
    uint32_t       REG15_DEBUG_CTRL;                       /*  REG15_DEBUG_CTRL */
    uint8_t        dummy21[28];                            /*                  */
    uint32_t       REG15_PREFETCH_CTRL;                    /*  REG15_PREFETCH_CTRL */
    uint8_t        dummy22[28];                            /*                  */
    uint32_t       REG15_POWER_CTRL;                       /*  REG15_POWER_CTRL */
};
...
#define L2C     (*(volatile struct st_l2c     *)0x3FFFF000uL) /* L2C */
...
#define L2C_FROM_REG9_D_LOCKDOWN0 (*(volatile struct st_l2c_from_reg9_d_lockdown0 *)&L2C.REG9_D_LOCKDOWN0) /* L2C_FROM_REG9_D_LOCKDOWN0 */
#define L2C_FROM_REG9_D_LOCKDOWN1 (*(volatile struct st_l2c_from_reg9_d_lockdown0 *)&L2C.REG9_D_LOCKDOWN1) /* L2C_FROM_REG9_D_LOCKDOWN1 */
#define L2C_FROM_REG9_D_LOCKDOWN2 (*(volatile struct st_l2c_from_reg9_d_lockdown0 *)&L2C.REG9_D_LOCKDOWN2) /* L2C_FROM_REG9_D_LOCKDOWN2 */
#define L2C_FROM_REG9_D_LOCKDOWN3 (*(volatile struct st_l2c_from_reg9_d_lockdown0 *)&L2C.REG9_D_LOCKDOWN3) /* L2C_FROM_REG9_D_LOCKDOWN3 */
#define L2C_FROM_REG9_D_LOCKDOWN4 (*(volatile struct st_l2c_from_reg9_d_lockdown0 *)&L2C.REG9_D_LOCKDOWN4) /* L2C_FROM_REG9_D_LOCKDOWN4 */
#define L2C_FROM_REG9_D_LOCKDOWN5 (*(volatile struct st_l2c_from_reg9_d_lockdown0 *)&L2C.REG9_D_LOCKDOWN5) /* L2C_FROM_REG9_D_LOCKDOWN5 */
#define L2C_FROM_REG9_D_LOCKDOWN6 (*(volatile struct st_l2c_from_reg9_d_lockdown0 *)&L2C.REG9_D_LOCKDOWN6) /* L2C_FROM_REG9_D_LOCKDOWN6 */
#define L2C_FROM_REG9_D_LOCKDOWN7 (*(volatile struct st_l2c_from_reg9_d_lockdown0 *)&L2C.REG9_D_LOCKDOWN7) /* L2C_FROM_REG9_D_LOCKDOWN7 */

/* End of channnel array defines of L2C */


#define L2CREG0_CACHE_ID L2C.REG0_CACHE_ID
#define L2CEG0_CACHE_TYPE L2C.EG0_CACHE_TYPE
