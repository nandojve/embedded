...
* Description   : Sample Program vecotr.s
*******************************************************************************/
/*******************************************************************************
...
#else	/* ARM_SIM */
#define RIIC_0 (*(volatile struct st_riic_n *)0x49FEE000)    /* RIIC_0 Address */
#define RIIC_1 (*(volatile struct st_riic_n *)0x49FEE400)    /* RIIC_1 Address */
#define RIIC_2 (*(volatile struct st_riic_n *)0x49FEE800)    /* RIIC_2 Address */
#define RIIC_3 (*(volatile struct st_riic_n *)0x49FEEC00)    /* RIIC_3 Address */
#endif	/* ARM_SIM */
