...
******************************************************************************/
/* ====  Prototype function ==== */
static void Userdef_INTC_Dummy_Interrupt(uint32_t);

/* ==== Global variable ==== */
void (* intc_FuncTable[INTC_ID_TOTAL])(uint32_t) __attribute__ ((section (".data")))=
//SRSRvoid (* intc_FuncTable[INTC_ID_TOTAL])(uint32_t) =
{
    ...
    Userdef_INTC_Dummy_Interrupt,        /* 365 : INT_CSIH0TIR  */
    Userdef_INTC_Dummy_Interrupt,        /* 366 : INT_CSIH0TIRE */
    Userdef_INTC_Dummy_Interrupt,        /* 367 : INT_CSIH1TIC  */
    Userdef_INTC_Dummy_Interrupt,        /* 368 : INT_CSIH1TIJC */
    Userdef_INTC_Dummy_Interrupt,        /* 369 : ECCE10        */
    Userdef_INTC_Dummy_Interrupt,        /* 370 : ECCE20        */
    Userdef_INTC_Dummy_Interrupt,        /* 371 : ECCOVF0       */
    Userdef_INTC_Dummy_Interrupt,        /* 372 : ECCE11        */
    Userdef_INTC_Dummy_Interrupt,        /* 373 : ECCE21        */
    Userdef_INTC_Dummy_Interrupt,        /* 374 : ECCOVF1       */
    Userdef_INTC_Dummy_Interrupt,        /* 375 : ECCE12        */
    Userdef_INTC_Dummy_Interrupt,        /* 376 : ECCE22        */
    Userdef_INTC_Dummy_Interrupt,        /* 377 : ECCOVF2       */
    Userdef_INTC_Dummy_Interrupt,        /* 378 : ECCE13        */
    Userdef_INTC_Dummy_Interrupt,        /* 379 : ECCE23        */
    Userdef_INTC_Dummy_Interrupt,        /* 380 : ECCOVF3       */
...
* Return Value : none
******************************************************************************/
static void Userdef_INTC_Dummy_Interrupt(uint32_t sense)
{
    sense;
    /* Do Nothing */
}
...
* Return Value : none
******************************************************************************/
void Userdef_INTC_HandlerExe(uint16_t int_id)
{
    intc_FuncTable[int_id](0);
}
...
* Return Value : none
******************************************************************************/
void Userdef_INTC_RegistIntFunc(uint16_t int_id, void (* func)(uint32_t))
{
    intc_FuncTable[int_id] = func;
}
...
uint32_t ulInterruptID;
	...
	if(ulInterruptID < INTC_ID_TOTAL)
	{
		...
		intc_FuncTable[ ulInterruptID ]( 0 );
	}
}
