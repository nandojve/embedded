...
static stkalign_t *waTable[OS_PORT_MAX_TASKS];
 ...
 * @return The fonction returns TRUE if the task was successfully
 ...
 * @return The fonction returns TRUE if the event object was successfully
 *   created. Otherwise, FALSE is returned
 **/

bool_t osCreateEvent(OsEvent *event)
{
   //Initialize the binary semphore object
 ...
 * @return The fonction returns TRUE if the semaphore was successfully
 *   created. Otherwise, FALSE is returned
 **/
 ...
 * @return The fonction returns TRUE if the mutex was successfully
 *   created. Otherwise, FALSE is returned
 **/
