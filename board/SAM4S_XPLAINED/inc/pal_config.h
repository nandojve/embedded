 ...
 * @file pal_config.h
 *
 * @brief PAL configuration for SAM4S_XPLAINED
 *
...
#define PIN_SPI_NPCS					{PIO_PA31A_NPCS1, PIOA, ID_PIOA, PIO_PERIPH_A, PIO_DEFAULT}
...
#define BOARD_TRX_NPCS_PIN				PIO_PA31A_NPCS1
...
/*
 * SPI Base Register:
 * SPI0 is used by SAM4S_XPLAINED
 */
#define SPI_USED						(SPI)
 ...
 */
#define ALERT_INIT()					{PIN_SET_AS_PIO_OUTPUT((PIN_LED_0_MASK | PIN_LED_1_MASK), PIN_LED_0_PIO);}
...
#define ALERT_INDICATE()				do										\
    {																			\
        bool pin_status;														\
        PIN_GET_STATUS(pin_status, (PIN_LED_0_MASK | PIN_LED_1_MASK), PIN_LED_0_PIO);				\
        if (pin_status)															\
        {																		\
            PIN_CLEAR((PIN_LED_0_MASK | PIN_LED_1_MASK), PIN_LED_0_PIO);		\
        }																		\
        else																	\
        {																		\
